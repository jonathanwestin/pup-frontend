export default [
  {
    ...
    authors: [
      ...
      {
        name: ["Gunnar", "Almevik"],
        affiliation: ["Department of Conservation", "University of Gothenburg"],
      },
    ],
    ...
    revisions: [
      {
        ...
        date: "2021-01-20",
        title:
          "3 Observations on filming Tactility and Movement in Crafts-based Practise",
      },
      {
        revision_number: 2,
        date: "2021-03-17",
